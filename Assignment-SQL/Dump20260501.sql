...
--
-- Temporary view structure for view `basic_film_view`
--

DROP TABLE IF EXISTS `basic_film_view`;
/*!50001 DROP VIEW IF EXISTS `basic_film_view`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `basic_film_view` AS SELECT 
 1 AS `title`,
 1 AS `length`,
 1 AS `rental_rate`*/;
SET character_set_client = @saved_cs_client;
...
CREATE TABLE `film` (
  ...
  FULLTEXT KEY `idx_film_description` (`description`),
...
--
-- Table structure for table `rental_copy`
--

DROP TABLE IF EXISTS `rental_copy`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `rental_copy` (
...
--
-- Final view structure for view `basic_film_view`
--
...
/*!50001 VIEW `basic_film_view` AS select `film`.`title` AS `title`,`film`.`length` AS `length`,`film`.`rental_rate` AS `rental_rate` from `film` where (`film`.`length` > 120) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2026-05-01 10:21:23
